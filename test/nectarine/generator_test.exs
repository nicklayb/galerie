defmodule Nectarine.GeneratorTest do
  use Nectarine.DataCase
  alias Nectarine.Generator
  alias NectarineTest.Support.Mocks.MockGenerator
  ...
  describe "unique/2" do
    test "generate unique value without failing if value doesn't exist" do
      ...
      assert uuid ==
               Generator.unique({MockGenerator, value: uuid}, schema: {Nectarine.User, :email})
    end
