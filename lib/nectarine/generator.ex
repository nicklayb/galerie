defmodule Nectarine.Generator do
  @moduledoc """
  ...
  @typedoc "Module implementing the Nectarine.Generator behaviour"
  ...
  defp default_max_tries,
    do: Application.fetch_env!(:nectarine, Nectarine.Generator)[:default_max_tries]
end
